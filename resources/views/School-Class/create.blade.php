    ...
    <header class="bg-[#16213A] text-white">
        ...
        <div class="mx-auto flex max-w-5xl items-center justify-between px-6 py-5">
            ...
            <nav class="hidden gap-8 text-sm md:flex">
                ...
                <a href="#" class="text-white/55 hover:text-white">Nama</a>

                <a href="#" class="text-white/55 hover:text-white">Jenis Kelamin</a>

                <a href="#" class="text-white/55 hover:text-white">Mata Pelajaran</a>

                <a href="#" class="text-white/55 hover:text-white">No. Telepon</a>

                <a href="#" class="text-white/55 hover:text-white">Status</a>
